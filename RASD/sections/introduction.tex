...
\begin{itemize}
    ...
    \item \emph{Totem}: A physical device with a touchscreen display that allows Customers to join the Virtual Line.
    \item \emph{Virtual Line}: the virtual equivalent of a physical line in front of the store, regulating the access of people by ordering them.
\end{itemize}
