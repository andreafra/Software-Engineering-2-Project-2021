...
\item
  ...
  thetotem is installed. \emph{\textbf{Note:} For the purposes of the demo, the user interface of the totem contains fields to specify the auth token and the store id. In the final systems these would be hard-coded and dependent on where the totem is installed.}
\item
