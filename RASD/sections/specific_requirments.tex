...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{uml/join_queue.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{uml/reserve_timeslot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{uml/state_chart.png}
    \label{fig:seqdiag-reserve-timeslot}
    \caption{State chart}
\end{figure}
