...
\begin{itemize}
    ...
    \item Booking/Making A Reservation: \info{Book is the verb, reservation is the noun (in order to avoid incomprensioni)}Act of making an arrangement my a User to have a Visit to a specific Store at a specific time.
